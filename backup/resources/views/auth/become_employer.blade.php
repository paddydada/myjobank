                ...
                <div class="col-xl-6 offset-xl-3">
                    <div class="utf-login-register-page-aera margin-bottom-50">
                        <div class="utf-welcome-text-item">
                            <h3>Become Employer</h3>
                            <span>Don't Have an Account? <a href="{{ route('employer.login') }}">Employer Log In!</a></span>
                        </div>
                        <div class="utf-account-type">

                            <div>
                                <a href="{{ url('/become/employer') }}">  <input type="radio"
                                ...
                                <label for="freelancer-radio" class="utf-ripple-effect-dark"
                                    data-tippy="" data-original-title="Employer"><i
                                        class="icon-material-outline-account-circle"></i>Create Employer </label>
                            </div>
                        </a>
                            ...
                            <a href="{{ url('/register') }}">
                                <div>
                                    ...
                                    <label for="employer-radio" class="utf-ripple-effect-dark" >
                                        <i class="icon-material-outline-business-center"></i> Jobseeker
                                    </label>
                                </div>
                            </a>
                        ...
                        <form method="post" id="utf-register-account-form" action="{{ route('employer.register') }}">
                            @csrf

                            <div class="utf-no-border">
                                <input type="text" class="utf-with-border" name="name" placeholder="Company Name">
                            </div>
                            @error('name')
                            ...
                            <div class="utf-no-border">
                                <input type="text" class="utf-with-border" name="username" placeholder="User Name">
                            </div>
                            @error('username')
                                <span class="mt-2" style="color:#FF8A00;">{{ $message }}</span>
                            @enderror
