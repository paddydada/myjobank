                ...
                <div class="col-md-12">
                    <ul class="intro-stats margin-top-45 hide-under-992px">
                        <li><i class="icon-material-outline-business-center"></i> <sub class="counter_item"><strong
                                    class="counter">18,955</strong> <span>Live Jobs
                                    Posted</span></sub> </li>
                        <li><i class="icon-material-outline-assignment"></i> <sub class="counter_item"><strong
                                    class="counter">11,088</strong> <span>Jobs Candidate</span></sub> </li>
                        <li><i class="icon-material-outline-library-books"></i> <sub class="counter_item"><strong
                                    class="counter">10,758</strong> <span>Companies Jobs</span></sub> </li>
                    </ul>
                </div>
            </div>
        </div>
...
@foreach ($jobs as $item)
    <div id="notification" class="notification" style="display: none;">Please login first then you can apply the job.</div>
            ...
            <div class="utf-job-listing-description">
                ...
                <div class="utf-job-listing-footer">
                    <ul>
                        ...
                        <li><i class="icon-material-outline-account-balance-wallet"></i> ${{ $item->min }}-${{ $item->max }}</li>
                        <li><i class="icon-material-outline-location-on"></i> {{ $item->country_name }}</li>
                        <li><i class="icon-material-outline-access-time"></i> 15 Minute Ago</li>
                    </ul>
                </div>
            </div>
            @if (Auth::check())
                <a href="{{ route('jobseeker.post', ['jobId' => $item->id]) }}" class="list-apply-button ripple-effect">Apply Job <i class="icon-line-awesome-briefcase"></i></a>
            @else
                <span class="list-apply-button ripple-effect" onclick="showNotification()">Apply Job <i class="icon-line-awesome-briefcase"></i></span>
            @endif
        </div>
    </div>
@endforeach
        ...
        document.getElementById('notification').style.display = 'block';
                    ...
                    <div class="utf-centered-button margin-top-10">
                        <a href="jobs-list-layout-leftside.html"
                            class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-20">Browse All
                            Jobs <i class="icon-feather-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-md-6">
                    <a href="#" class="photo-box"
                        data-background-image="{{ asset('frontend/images/popular-location-03.jpg') }}">
                        <div class="utf-opening-box-content-part">
                            <h3>Dubai</h3>
                            <span>832 Jobs</span>
                        </div>
            ...
            <div class="utf-testimonial-carousel-block testimonials">
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        <div class="utf-testimonial-avatar-photo"> <img
                                src="{{ asset('frontend/images/user.png') }}" alt=""> </div>
                        <div class="utf-testimonial-author-utf-detail-item">
                            <h4>Rahul Roy</h4>
                            <span>Graphics Designer</span>
                        </div>
                        <div class="testimonial">Embarking on my career as a Graphics Designer felt like a challenging endeavor until I stumbled upon this remarkable platform. Its extensive collection of job opportunities catered specifically to my skills and interests, simplifying the otherwise overwhelming job search process. The platform's user-friendly interface made navigation effortless, allowing me to focus my energy on showcasing my creativity and talent. Thanks to this platform, I've found my dream role as a Graphics Designer and am excited to continue pushing the boundaries of visual storytelling.</div>
                    </div>
                </div>
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        ...
                        <div class="testimonial">Transitioning into the world of iOS development seemed like a daunting task until I discovered this platform. The curated job listings and intuitive interface streamlined my job search, allowing me to focus on what I do best – crafting exceptional iOS experiences. Within no time, I found a position that aligned perfectly with my skills and career goals. This platform has truly been a game-changer for my journey as an iOS developer, and I couldn't be more grateful for the opportunity it has provided me.</div>
                    </div>
                </div>
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        ...
                        <div class="testimonial">Thanks to this platform, my journey to becoming an Android Developer has been nothing short of incredible. The vast array of job opportunities tailored specifically to my skills made the job search process seamless. The interface is intuitive, making navigation effortless. Within a short period, I found a role that perfectly matched my expertise and career aspirations. I couldn't be happier with my experience and highly recommend this platform to any aspiring Android Developer.</div>
                    </div>
                </div>
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        ...
                        <div class="utf-testimonial-author-utf-detail-item">
                            <h4>John Williams</h4>
                            <span>Kishor Singh</span>
                        </div>
                        <div class="testimonial">Securing a job as a Web Developer was made effortless through this platform. With its comprehensive job listings and user-friendly interface, I quickly found the perfect opportunity. The application process was seamless, and I appreciated the personalized support from the team. Thanks to this website, I am now thriving in my new role as a Web Developer.</div>
                    </div>
                </div>
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        ...
                        <div class="utf-testimonial-author-utf-detail-item">
                            <h4>John Williams</h4>
                            <span>Adhitya Kuamr</span>
                        </div>
                        <div class="testimonial">Finding a job as a UI/UX Designer in the USA was a daunting task until I discovered this online platform. The user interface is intuitive, making job searching a breeze. Within weeks of signing up, I landed multiple interviews and eventually secured my dream job. I highly recommend this website to any designer looking to advance their career in the USA.</div>
                    </div>
                </div>
            </div>
        </div>
