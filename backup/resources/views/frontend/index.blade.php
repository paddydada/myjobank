                ...
                <div class="col-xl-12">
                    ...
                    <div class="utf-listings-container-part compact-list-layout margin-top-35">
                        ...
                        @foreach ($jobs as $item)
                            <div id="notification" class="notification">Please login first then you can apply the job.</div>
                            ...
                            @else
                                <div class="utf-job-listing utf-apply-button-item">
                                    <div class="utf-job-listing-details">
                                        ...
                                        <span class="list-apply-button ripple-effect" onclick="showNotification()">Apply
