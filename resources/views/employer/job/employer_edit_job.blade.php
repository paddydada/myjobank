            ...
            <div class="col-xl-12 mx-auto">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('employer.job.update', ['id' => $job->id]) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="cat_name" name="cat_name" class="form-select @error('cat_name') is-invalid @enderror">
                                    ...
                                    @foreach(App\Models\jobcategory::all() as $category)
                                        <option value="{{ $category->cat_name }}" {{ $category->id == old('cat_name', $selectedCategoryId) ? 'selected' : '' }}>
                                            {{ $category->cat_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ $job->country_name }}" name="country_name"
                                    id="country_name">
