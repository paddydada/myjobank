<div class="sidebar-wrapper" data-simplebar="true">
  ...
  <li>
    ...
    <i class="fadeIn animated bx bx-align-justify"></i>
            ...
            <ul>
                <li> <a href="{{ route('australia.leads') }}"><i class="bx bx-right-arrow-alt"></i>Australia Leads</a>
                </li>
                <li> <a href="{{ route('canada.leads') }}"><i class="bx bx-right-arrow-alt"></i>Canada Leads</a>
                </li>
            </ul>
        </li>
        ...
        <li>
          ...
          <li>
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Applied All Jobs</div>
            </a>
            <ul>
                <li> <a href="{{ route('job.applied.all') }}"><i class="bx bx-right-arrow-alt"></i>Applied All Job </a>
                </li>
                <li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Australia applied User</a>
                </li>
 <li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Canada applied User</a>
                </li>
