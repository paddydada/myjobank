    ...
    <div class="utf-dashboard-content-container-aera" data-simplebar>
        ...
        <div class="utf-submit-field">
            ...
            <div class="input-group">
                <input type="text" class="form-control"  value="{{ ($userData->location) }}" disabled>
            </div>
        </div>
    </div>
        ...
        <div class="utf-submit-field">
            <h5>Phone Number</h5>
            <div class="input-group">
                <input type="tel" class="form-control" id="phoneNumber" name="phone" value="{{ ($userData->phone) }}" required>
            </div>
        </div>
    </div>
